  ...
  { const classes =useStyles();
    ...
    const handleClick=async()=>{
        ...
        if(isBlank(accessoriesName)){
            error=true
            msg+="<font color='#e74c3c'><b>Accessories Name should not be blank..</b></font><br> "
        }
        ...
        formData.append("accessoriesname",accessoriesName)
        formData.append("description",accessoriesDescription)
        ...
        <div className={classes.root} >
            <div className={classes.subdiv} >
                <Grid container spacing={1}>
                    ...
                    <Grid item xs={12}>
                       <TextField onChange={(event)=>setAccessoriesName(event.target.value)} label="Accessories Name" variant="outlined" fullWidth/>
                    </Grid>

                    <Grid item xs={12}>
                       <TextField onChange={(event)=>setAccessoriesDescription(event.target.value)} label="Accessories Description" variant="outlined" fullWidth/>
                    </Grid>

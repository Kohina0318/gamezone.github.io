...
const handleCancelAd=()=>{
  ...
  setAd({btyes:"",file:`${ServerURL}/images/${getRowData.ad}`})
}
    ...
    <div className={classes.root} >
        <div className={classes.subdiv} >
            <Grid container spacing={1}>
                ...
                <Grid item xs={12}>
                   <TextField value={subcategoryDescription} onChange={(event)=>setSubCategoryDescription(event.target.value)} label="SubCategory Description" variant="outlined" fullWidth/>
                </Grid>

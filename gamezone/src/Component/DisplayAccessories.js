...
const handleDelete=async()=>{
  ...
  var body={accessoriesid:accessoriesID}
  var result=await postData("accessories/deleteaccessories",body)

  if(result){
    swal({
        title: "Accessories Deleted Successfully",
        icon: "success",
        dangerMode: true,
      })
  }
...
const handleClick=async()=>{
  ...
  if(isBlank(subcategoryId)){
    ...
    if(isBlank(accessoriesName)){
        error=true
        msg+="<font color='#e74c3c'><b>Accessories should not be blank..</b></font><br> "
    }
    if(isBlank(accessoriesDescription)){
        error=true
    ...
    <div className={classes.root} >
        <div className={classes.subdiv} >
            <Grid container spacing={1}>
                ...
                <Grid item xs={12}>
                   <TextField value={accessoriesName} onChange={(event)=>setAccessoriesName(event.target.value)} label="Accessories Name" variant="outlined" fullWidth/>
                </Grid>

                <Grid item xs={12}>
                   <TextField value={accessoriesDescription} onChange={(event)=>setAccessoriesDescription(event.target.value)} label="Accessories Description" variant="outlined" fullWidth/>
                </Grid>
...
const handleClickOpen = (rowData) => {
  ...
  setAccessoriesName(rowData.accessoriesname)
  setAccessoriesDescription(rowData.description)
    ...
    return (
      ...
      <MaterialTable
        ...
        columns={[
          ...
          { title: 'Id', field: 'accessoriesid' },
          { title: 'Name', field: 'accessoriesname' },
